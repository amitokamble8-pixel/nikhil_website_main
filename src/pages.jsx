...
export function Home() {
  ...
  return (
    <>
      ...
      <section className="section">
        <SectionHead title="Current research" eyebrow="Mentored & Independent" />
      ...
      <section className="section">
        <SectionHead title="Projects" eyebrow="Built & Presented" />
        <div className="grid-2">
      ...
      <section className="section">
        <SectionHead title="Leadership & Teaching" eyebrow="Clubs · Music · Community" />
        <Reveal>
...
export function About() {
  ...
  return (
    <section className="section">
      <PageHead title="About" eyebrow="Bergen County Academies · Class of 2027" />
      ...
      <SubHead title="Education" eyebrow="Rutherford, New Jersey" />
      <div className="stack">
        {EDUCATION.map((e, i) => (
...
export function Work() {
  ...
  return (
    <section className="section">
      <PageHead title="Research & Experience" eyebrow="Mentored & Independent" />
      <div className="grid-2">
        {EXPERIENCE.map((e, i) => (
...
export function Sports() {
  ...
  return (
    <section className="section">
      <PageHead title="Music & Activities" eyebrow="Ensembles · Hackathons" />
